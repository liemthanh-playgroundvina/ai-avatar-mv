...
if __name__ == "__main__":
    ...
    try:
        output = inference_process(command_line_args)
        result = {"path": output}
    except IndexError:  # Don't find face
        result["error"] = {"type": "ValueError",
                           "message": "Face not detected in the image, please choose an image with a face or try again with a different image."}
